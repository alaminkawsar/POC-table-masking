...
## 📌 Project Overview
This research project focuses on automatically detecting and masking sensitive information in **UI screenshots** (mobile/web applications) based on **user-defined rules**. The system analyzes UI elements such as tables, text fields, dropdowns, and labels, extracts text, understands layout structure, and applies visual masking to specified values.
